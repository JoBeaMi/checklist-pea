...
• Reforçar positivamente tentativas de interação social`,
            estrategias_grau2: `• Ensino explícito de competências sociais com modelo direto (demonstrar exatamente como fazer)
• Criar histórias sociais personalizadas para situações específicas que causam dificuldade
• Não forçar situações sociais desconfortáveis - respeitar limites e validar sentimentos
...
• Construir um guião escrito ou visual para conversações comuns
• Criar sistema de pares com colega preparado para apoiar interações`
        },
        {
...
• Promover a criançao de pequenos grupos de pares (mais empáticos se neessário) com rotação de elementos
...
• Promover atividades baseadas em interesses especiais do aluno para criar pontos de conexão natural
• Preparar atividades curtas e simples, por serem frequentemente mais eficazes que atividades longas
...
• Criar oportunidades para que o aluno possa demonstrar as suas competências especiais aos pares`
        },
        {
            ...
            estrategias_grau1: `• Facilitar o acesso ao espaço 'seguro' para autorregulação quando necessário
...
• Permitir sentar longe de fontes de ruído (porta, janela com ruído exterior)`,
            estrategias_grau2: `• Garantir a disponibilidade de auriculares de cancelamento de ruído de alta qualidade sempre que necessários
• Criar espaço 'seguro' insonorizado ou com ruído reduzido para autorregulação
• Personalizar espaço individual de trabalho considerando a acústica
...
• Utilizar versões das ferramentas de trabalho e de ensino em papel com fundo mate em vez de projeções
...
• Disponibilizar objetos sensoriais que satisfaçam mesma necessidade de forma mais discreta
• Ensinar ao grupo que são movimentos que ajudam o colega a concentrar-se, a regular-se e por vezes a normalizar
...
• Criar "zona de movimento livre" onde as estereotipias são sempre permitidas
• Compreender que aumento deste sinal pode indicar sobrecarga - investigar e ajustar ambiente`
        }
    ],
    "EMOÇÕES E EMPATIA": [
        {
...
• Ensinar que expressão de empatia pode ser diferente mas o sentimento é genuíno`,
...
• Praticar reconhecimento de emoções em contextos reais ("Como achas que a Maria se está a sentir?")
...
• Reconhecer que o aluno sente empatia, mesmo que possa não expressar da forma esperada ou convencional
...
• Proporcionar oportunidades de grupo para falar sobre emoções e sentimentos
• Validar todas as formas de expressão emocional, desde que não prejudiciais para o próprio ou os outros`,
...
• Implementar "zonas de autorregulação" com todo o grupo
...
• Ensinar a pedir ajuda quando confuso ou zangado - tornar este processo seguro e fácil
...
• Reconhecer sinais precoces de frustração`,
            estrategias_grau2: `• Compreender que alunos com PEA fazem esforço cognitivo enorme - a sensação de exaustão é real
...
• Identificar padrões: hora do dia, tipos de tarefa, contextos que desencadeiam sobrecargas
...
• Reduzir ansiedade através de previsibilidade máxima`
        ...
        {
            sinal: "Desregula-se perante mudanças, imprevistos e surpresas na rotina sem aviso prévio",
...
• Antecipar mudanças com a máxima antecedência (dias, não minutos)
...
• Simplificar linguagem quando necessário`,
            estrategias_grau2: `• Usar sempre o nome do aluno antes de dar instruções para garantir atenção
...
• Reduzir informação auditiva concorrente (ruído de fundo) quando dá instruções
• Verificar compreensão de vocabulário novo - não assumir que o aluno compreende, mesmo que lhe pareçam simples
...
• Normalizar o acto de pedir ajuda, para todo o grupo
• Usar apoios visuais para facilitar pedidos de ajuda`,
...
• Fazer 'check-ins' frequentes e discretos sem colocar o aluno em exposição
...
• Permitir comunicar as dificuldades por escrito, se fôr mais confortável
• Ter uma pessoa de referência clara que o aluno sabe que pode ajudar sempre
...
• Disponibilizar modelos visuais de raciocínio abstrato
• Permitir demonstrar o que compreende e aprende de formas alternativas (visual, prática) não apenas verbal
...
• Aceitar formatos alternativos de resposta`,
            estrategias_grau2: `• Disponibilizar teclado/tablet para maior parte da escrita
...
• Disponibilizar folhas com espaços aumentados, linhas guia
• Permitir instrumentos de escrita alternativos (lápis triangulares, grips)
• Dar tempo extra para tarefas escritas
• Não avaliar caligrafia quando avaliar conteúdo
• Usar materiais manipuláveis para matemática em vez de apenas escrita
• Disponibilizar notas/apontamentos para copiar em vez de exigir sempre que copie do quadro
...
• Nunca penalizar dificuldades motoras - adaptar a tarefa, não baixar expectativas cognitivas`
        }
    ]
};
